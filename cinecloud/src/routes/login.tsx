          ...
          <Tabs value={view === 'signup' ? 'signup' : 'signin'} onValueChange={(v) => setView(v as LoginTabsView)}>
            <CardHeader className="space-y-1">
              ...
              <CardDescription className="text-slate-400">
                {view === 'signin' && 'Enter your credentials to access the dashboard'}
                {view === 'signup' && 'Join CineCloud to manage your cinema operations'}
                {view === 'confirm' && `Sent a verification code to ${username}`}
              </CardDescription>
            </CardHeader>
