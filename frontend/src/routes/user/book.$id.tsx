      ...
      <div className="flex items-center justify-between">
        ...
        {lockInfo && (
          <CountdownTimer
            ...
            onWarning={() => toast.warning('Less than 2 minutes remaining!')}
          />
        )}
      </div>
          ...
          <Card className="border-slate-700/50 bg-slate-800/50">
            <CardHeader>
              ...
              <p className="text-sm text-slate-400">
                Select up to {MAX_SEATS} seats. Click to select/deselect.
              </p>
            </CardHeader>
            <CardContent>
              <SeatMap
                room={room}
                occupiedSeats={
                  seatStatus?.occupied_seats || showtime.occupied_seats
                }
            ...
            <CardContent className="space-y-4">
              ...
              {lockInfo && (
                <p className="text-center text-xs text-slate-500">
                  Your seats are reserved for 10 minutes. Complete your booking
