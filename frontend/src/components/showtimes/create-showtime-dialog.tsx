...
import { Plus, Calendar, Clock, DollarSign, Film, Building2 } from 'lucide-react'
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-2xl">Create New Showtime</DialogTitle>
          <DialogDescription>
            Schedule a new screening for a movie in a specific room
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {formData.movie_id && formData.room_id && formData.date && formData.time && (
            <div className="rounded-lg border border-amber-500/20 bg-amber-500/5 p-4">
              <h4 className="mb-2 font-semibold text-amber-500">Screening Summary</h4>
