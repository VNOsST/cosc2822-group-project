...
function getSeatStyles(status: SeatStatus): string {
  ...
  switch (status) {
    ...
    case 'occupied':
      return cn(baseStyles, 'bg-red-500/50 text-red-200 cursor-not-allowed')
    case 'locked':
      return cn(
        baseStyles,
    ...
    case 'unavailable':
      return cn(baseStyles, 'bg-slate-800 text-slate-600 cursor-not-allowed')
    default:
      return baseStyles
  }
}
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative">
        ...
        <p className="mt-2 text-center text-xs text-slate-500">SCREEN</p>
      </div>
